...
public record LikeRelationship(UserNode source, PostNode target, LocalDateTime createdAt) {
  ...
  public LikeRelationship(final @NotNull UserNode source, final @NotNull PostNode target) {
  ...
  public String createCypher() {
    ...
    return String.format(
        query, this.source.userId(), this.target.postId(), this.createdAt.toString());
  }
